...
import { type AuthResponse } from '../types/auth'; // Ensure this type exists as discussed
...
const Login: React.FC = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            // NOTE: Ensure your CDK stack uses POST for /login
            ...
            if (response.data.token) {
                ...
                // Optional: Store userId or other info
    ...
    return (
        <AuthLayout title="Sign in to Itemizer">
